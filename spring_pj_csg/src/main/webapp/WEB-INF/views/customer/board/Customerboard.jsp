   ...
   <div class="wrap">
      ...
      <div id="container">
         <div id="contents">
            <!-- 상단 중앙1 시작 -->
            <div id="section1">
              <h1 style="font-family:'Gowun_Batang',serif"> Board - Notice </h1>
              <br>· 이 곳에서 공지사항을 확인하실 수 있습니다.<br>·
            </div>
                        ...
                        <c:forEach var="dto" items="${list}">
                           ...
                           <tr style="align:center; border-bottom:1px solid black;">
                              ...
                              <td style="text-align: center;"">
                                    <a href="${path}/BoardDetailAction.bo?num=${dto.num}">${dto.title}</a>
                                    <!-- 댓글 갯수 -->
                           ...
                           <div class="paging" style="margin-left:-80px">
                              ...
                              <c:if test="${paging.startPage > 10 }">
                               <a href="${path}/Customerboard.bo?pageNum=${paging.prev}">이전</a>
                              </c:if>
                              
                              <!-- 페이지 번호 처리 -->
                              <c:forEach var="num" begin="${paging.startPage}" end="${paging.endPage}">
                                  <a href="${path}/Customerboard.bo?pageNum=${num}">${num}</a> 
                                 
                              
                              </c:forEach>
                              <!-- 다음 버튼 활성화 여부 -->
                              <c:if test="${paging.endPage < paging.pageCount}">
                                 <a href="${path}/Customerboard.bo?pageNum=${paging.next}">다음</a>
                              </c:if>                              
