...
<%@ page import="spring.mvc.pj_117_csg.dto.CustomerDTO" %>
		                     ...
		                     <%-- <c:if test="${selectCnt == 1}"> --%>
			                        ...
			                        <table>
			                           ...
			                           <tr>
			                              ...
			                              <td colspan="2">
			                                 <input type="password" class="input" name="password" size="5" placeholder="공백없이 20자 이내로 작성">
			                              </td>
			                           ...
			                           <tr>
			                              ...
			                              <!--인풋태그명 디티오 멤버변수, 컬럼명이  일치해야한다  -->
			                              <td colspan="2">
			                                 <input type="password" class="input" name="repassword" size="5" placeholder="비밀번호 확인">
			                              </td>
			                           </tr>
			                           <tr>
			                              <th>* 이름</th>
