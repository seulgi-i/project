      ...
      <h3 class="title bottom-1" >자동이체등록</h3><!-- Title Post -->
       			...
       			<td width = "800">
          			<select name="ACCOUNT">
           			  <c:forEach var="sdto" items="${sList}" varStatus="status">
		                  <option value="${sdto.ACCOUNT}" id="${sdto.ACCOUNT}">${sdto.PRODUCT_NAME}${sdto.ACCOUNT}</option>
	                  </c:forEach>
          			</select>
       ...
       <table class="style color" width="600px">
       		...
       		<tr>
       			<th> 입금계좌번호</th>
       			<td>
       				<input type="text" name="auto_senderAccount" id="auto_senderAccount" placeholder="'-'없이 숫자만 입력" />
       		...
       		<tr>
       			<th>이체금액</th>
       			<td>
       				<input type="number" name="auto_balance" required/>원
       			</td>
       		</tr>
       		<tr>
       			<th>이체 주기</th>
       		...
       		<tr>
       			<th>이체 시작일/종료일</th>
       			<td>
       				<input type="date" id="datepicker1" name="auto_registDate">
					<input type="date" id="datepicker2" name="auto_expirationDate">
				</td>
       		...
       		<tr>
       			<th>이체기관명(내용)</th>
       			<td>
       				<input type="text" name="auto_inPlace"/>
       			</td>
       		</tr>
       </table>
