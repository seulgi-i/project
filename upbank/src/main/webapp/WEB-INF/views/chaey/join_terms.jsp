...
function chk(){
	var req = document.join_terms_form.req.checked;
	var num = 0;
	...
	if(num == 1){
  		location.href="${path}/join_whether.do";
 	}else{
...
<body>
   ...
   <!-- 메인시작  -->
   	<div>
		...
		<form action="#" name="join_terms_form" method="post">
		<!-- 따로 넘기는 정보가 없기떄문에 csrf 토큰은 우선 생략 -->
		...
		<div id="accordion2" class="accordion style2 top-3 bottom-3" style="width:80%; margin-left: 10%;">
			...
			<div><p>전자금융거래이용약관 등 관련 약관에 동의합니다.</p>
	        
	        	<div style="margin-left:5%; display:flex; text-align:center; justify-content: center;">
	          
		<table width="1600" height="800" style="margin:auto">
  			<tr>
   				<td height="20%" align="center" text-align="center">
   					<img src="${path}/resources/images/img/chaey/upbankTerms.png" width="350px;">
   				</td>
  			</tr>
  			<tr>
   				<td height="70%" align="center"><hr><br><p></p>
   					<textarea rows="30" cols="180" style="margin:auto;">
	...
	본 약관은 2017년 07월 1일부터 적용한다.
	   				...
	   				<input type="checkbox" name="req"> 개인정보 수집 및 이용에 동의합니다.<br><hr>
	   			</td>
	  		</tr>
	  		<tr>
	   			<td align="center" valign="top"><br>
				    <input type="button" class="button medium color bottom-2" value="동의" onclick="chk()">&nbsp;&nbsp;&nbsp;
				    <input type="button" class="button medium color bottom-2" value="거절" onclick="nochk()">    
	   			</td>
	  		</tr>
	 	</table>
	 			</div>
