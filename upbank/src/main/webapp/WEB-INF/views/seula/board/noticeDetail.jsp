     ...
     <div class="sixteen columns bottom-3">
      ...
      <div class="post-content" style="padding: 10px 5px 40px 5px;">
        ...
        ${dto.n_content}
		  ...
		  <input type="button" style="color:#ffffff;" value="수정" class="button1 small color" onclick="window.location='${path}/noticeUpdatePage.do?n_No='+${dto.n_No}">
		  <input type="button" style="color:#ffffff;" value="삭제" class="button1 small color" onclick="window.location='${path}/noticeDeleteAction.do?n_No='+${dto.n_No}">
          </c:if>
          <input type="button" style="color:#ffffff;" value="목록" class="button1 small color" onclick="window.location='${path}/notice.do'">
		  </div>
      </form>
     </div> 
     <!-- ==================== End Single Post  ==================== -->
