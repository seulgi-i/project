     ...
     <div class="sixteen columns bottom-3">
      ...
      <div class="post-content" style="padding: 10px 5px 40px 5px;">
        ...
        ${dto.c_content}
		  ...
		  <input type="button" style="color:#ffffff;" value="수정" class="button1 small color" onclick="window.location='${path}/cnsltUpdatePage.do?c_No='+${dto.c_No}">
		  <input type="button" style="color:#ffffff;" value="삭제" class="button1 small color" onclick="window.location='${path}/cnsltDeleteAction.do?c_No='+${dto.c_No}">
          <input type="button" style="color:#ffffff;" value="목록" class="button1 small color" onclick="window.location='${path}/cnslt.do'">
		  </div>
		  
		  <!-- 답변 내용 -->
		  
	<div class="comments-box"  style="background:#f9f9f9; margin-top:100px;">
      <hr class="bottom-2">
      ...
      <div  id="commentList">
		...
		<div class="comment-form top-4">
	      ...
	      <div class="form-box">
	        ...
	        <input type="text" id="cmt_name" name="name" class="text" value="${sessionScope.customerID}">
	      </div><!-- End Box -->
	      ...
	      <input type="button" style="color:#ffffff;" value="작성" class="button1 small color" id="btnSave">
