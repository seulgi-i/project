	...
	<%@ include file="leftBar.jsp"%>
     <!-- End -->
      ...
      <div class="form-box last" style="width:300px;">
        <label for="f_cnt" style=" display: block;">매수수량 <small></small></label>
      ...
      <div class="form-box last" style="width:300px;">
        <label for="show_totalPrice">매수금액  <small></small></label>
      ...
      <div class="form-box" style="width:300px;">
        <label for="show_finalTotalPrice"><span style="color:red; font-weight:bold;">총 결제금액 </span></label>
      ...
      <div class="form-box" style="width:310px;">
        <label for="show_ACCOUNT">출금계좌 </label>
      ...
      <input type="button" id="buyButton" value="매수" class="button1 medium color" style="width:271px;">
      </div>
    </div>
