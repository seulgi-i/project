...
<html>
<head>
<title>Upbank | 관리자 환전수령여부 체크</title>
</head>
<body>
 ...
 <!-- Start Posts -->
	     <div class="sixteen columns bottom-3">
	      ...
	      <div class="post-content">
	     	 <form name="curExcSelectAdminForm" action="${path}/CurrencyExchangeAdmin2.ad" method="post">
				<input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">	   	 	
	   	 		<table class="style color" >
	   	 			<tr>
	   	 				...
	   	 				<input type="submit" id="cur_input" value="조회" class="button1 small normal">
	   	 				</td>
	   	 			<tr>
		   	 			<th>환전신청인</th>
		   	 			<th>출금계좌번호</th>
					...
					<c:if test="${selectCnt != 0}">
						<c:forEach var="dto" items="${list }">
							<tr>
			   	 				...
			   	 				<td><input type="button" value="수령대기" onclick="location.href='${path}/CurrencyExchangeAdmin3.ad?num=${dto.num}&usercp=${dto.usercp}'"/></td>
			   	 				</c:if>
			   	 				<c:if test="${dto.enable !=1}">
			   	 				<td>수령완료</td>
			   	 				</c:if>
