...
<%@ include file="/WEB-INF/views/common/header.jsp" %>
   ...
   <!-- Start Posts -->
     <div class="sixteen columns bottom-3">
     	 <c:if test="${CurrencyCalc==0}">
		     <table class="style color" width="600px">
		     <tr>
		     	<td align="center">
			 	주말 및 공휴일 환율정보 미제공으로 환율 계산이 불가합니다.
			 	</td>
		     </tr>
		     </table>
		 </c:if>
     <c:if test="${currencyResult !=0}">
     ...
     <table class="style color" width="600px">
		...
		<tr>
			<td colspan="3" align="center">
		 	<font size="5"> ${won} 원 </font><font size="10"> : </font> <font size="10">${DcurrencyResult}</font><font size="5">${operator}</font>
		 	</td>
	 	</tr>
     </table>
     </form>
