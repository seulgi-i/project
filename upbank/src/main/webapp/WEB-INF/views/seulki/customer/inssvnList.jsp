				...
				<div class="post single style-1">
					...
					<form name="depositForm" method="post">
						...
						<c:forEach var="dto" items="${list}">
							...
							<input type="button" style="margin-top: 100;" class="button1 small color"value="상세보기"onclick="window.location='${path}/inssvnDetailAction.do?i_name=${dto.i_name}'">
							<c:if test="${sessionScope.customerID == null }">
						<input type="button" class="button1 small color"value="가입하기"onclick="alert('로그인 하세요.'); return false;">
						</c:if>
						<c:if test="${sessionScope.customerID != null }">
						<input type="button" class="button1 small color"value="가입하기"onclick="window.location='${path}/inssvnJoinDetail.do?i_name=${dto.i_name}'">
						</c:if>
							<br>
							<br>
							<hr class="line bottom-3"></hr>
