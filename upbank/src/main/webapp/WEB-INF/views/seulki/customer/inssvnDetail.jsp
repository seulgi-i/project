...
function input_Text6(){
	    document.getElementById("i_end_date").value = '6';
	}
...
function balance(button) {
	...
	document.getElementById("i_balance").value = sum;
...
$(function(){
	$("#calc").click(function(){
	 var param = {
			 "i_balance": $('#i_balance').val(),  /* key : value */
		     "i_end_date" : $('#i_end_date').val(),
		     "rate" : $('#rate').val()
		   }
	
	$.ajax({
		url: '${path}/inssvnculator_1.do?${_csrf.parameterName}=${_csrf.token}',
		type: 'post',
		data: param,
...
<body>
	...
	<div id="wrap" class="boxed">
					...
					<div class="services style-2 bottom-3" style="padding: 0 0 0 20px;">
 					...
 					<div class="one-third column" style="width:280px; margin: 0 50px 20px 0;">
				         <div class="item active bottom-3">
				           ...
				           <div class="data float-right">
				           <h5>금액</h5>
				           <h4><strong> <fmt:formatNumber pattern="###,###,###" value="${dto.i_min_price}" />원~
								      <fmt:formatNumber pattern="###,###,###" value="${dto.i_max_price}" />원</strong></h4>
				           </div>
				         </div>
				       </div><!-- End item -->
				         ...
				         <div class="item active bottom-3">
				           ...
				           <h5>최고 연</h5>
				           <h4>
				           		<strong><span style="font-size: 20px">${dto.rate}%(${dto.i_max_date}개월)</span></strong>
						   </h4>
				           </div>
				         </div>
				       </div><!-- End item -->
						...
						<c:if test="${sessionScope.customerID != null }">
						<a href="${path}/inssvnJoinDetail.do?i_name=${dto.i_name}" class="button1 small color"
        ...
        <div class="info-box" style="width: 1000px; font-size: 17px;">
          ...
          <input type="hidden" id="i_balance">
				        <input type="text" id="i_end_date" size="5" placeholder="기간" onclick="showDiv(this);"> 개월 간
		          ...
		          <input type="reset" class="button1 small color" onclick="location.reload();">
				    ...
				    <div id="i_end_dateBox" class="box">
				        <form method="post">
							...
							<div id="horizontal-tabs" class="two style2">
								...
								<div class="contents" style="margin-left: 300px;">
									<div id="content_two1" class="tabscontent" style="display: block; margin-left: 240px;">
										<a href="${dto.i_fileImg}" download> <strong> 약관
