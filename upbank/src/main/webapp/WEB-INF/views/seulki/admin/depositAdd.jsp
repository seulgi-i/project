...
<script type="text/javascript">
	...
	$(function() {
		$("#sumit_b").click(function() {
			document.depositAdd.action="${path}/depositAddAction.do?${_csrf.parameterName}=${_csrf.token}";
			document.depositAdd.submit();
		});
...
<body>
	...
	<div id="wrap" class="boxed">
        ...
        <h3 class="title bottom-2"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">예금상품추가</font></font></h3>
         <hr style="border: solid 2px #378AC4"><br>
         
        <form action="${path}/depositAddAction.do" method="post" name="depositAdd" enctype="multipart/form-data"  class="form-elements">
          <input type="hidden" name="${_csrf.parameterName}" value="${_csrf.token}">
		          ...
		          <th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">상품명 :</font></font></th>
		        	<td><input type="text" name="y_name" placeholder="상품명 입력"></td>
          		</tr>
         ...
         <tr>
          ...
          <td><input type="text" name="y_min_price" placeholder="최소 예치금액" ></td>
          </tr>
          
           <tr>
           <th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">최대예치금액 :</font></font></th>
           <td><input type="text" name="y_max_price" placeholder="최대 예치금액"></td>
          </tr>         
